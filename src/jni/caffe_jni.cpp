...
Java_bella_caffedemo_caffelibs_CaffeMobile_setBlasThreadNum(JNIEnv *env, jobject instance,
                                                            jint numThreads) {
  openblas_set_num_threads(numThreads);
}

JNIEXPORT jboolean JNICALL
Java_bella_caffedemo_caffelibs_CaffeMobile_loadModel(JNIEnv *env, jobject instance,
...
Java_bella_caffedemo_caffelibs_CaffeMobile_predict(JNIEnv *env, jobject instance,
...
Java_bella_caffedemo_caffelibs_CaffeMobile_inputChannels(JNIEnv *env, jobject instance) {
  // Predict
  caffe::CaffeMobile *caffe_mobile = caffe::CaffeMobile::get();
  if (NULL == caffe_mobile) {
...
JNIEXPORT jint JNICALL
Java_bella_caffedemo_caffelibs_CaffeMobile_inputWidth(JNIEnv *env, jobject instance) {
  // Predict
  caffe::CaffeMobile *caffe_mobile = caffe::CaffeMobile::get();
  if (NULL == caffe_mobile) {
      return -1;  // not initialized
...
JNIEXPORT jint JNICALL
Java_bella_caffedemo_caffelibs_CaffeMobile_inputHeight(JNIEnv *env, jobject instance) {
  // Predict
  caffe::CaffeMobile *caffe_mobile = caffe::CaffeMobile::get();
  if (NULL == caffe_mobile) {
    return -1;  // not initialized
